...
},{"array-flatten":31,"sliced":32}],31:[function(require,module,exports){
'use strict'
...
_superagent2['default'].get('/room/lobby', function (err, response) {
	chatMessages = chatMessages.concat(response.body.map(function (message) {
...
},{"../../../deps/phoenix/web/static/js/phoenix":1,"./messages":35,"deku":4,"superagent":27,"virtual-element":30}],35:[function(require,module,exports){
/** @jsx element */
'use strict';
